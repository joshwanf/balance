...
CREATE TABLE "TransactionsOnTags" (
    ...
    CONSTRAINT "TransactionsOnTags_pkey" PRIMARY KEY ("transactionId","tagId")
);
...
-- CreateIndex
CREATE INDEX "Tags_userId_cleanedName_idx" ON "Tags"("userId", "cleanedName");

-- CreateIndex
CREATE UNIQUE INDEX "Tags_userId_cleanedName_key" ON "Tags"("userId", "cleanedName");
...
-- AddForeignKey
ALTER TABLE "TransactionsOnTags" ADD CONSTRAINT "TransactionsOnTags_transactionId_fkey" FOREIGN KEY ("transactionId") REFERENCES "Transaction"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TransactionsOnTags" ADD CONSTRAINT "TransactionsOnTags_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES "Tags"("id") ON DELETE CASCADE ON UPDATE CASCADE;
